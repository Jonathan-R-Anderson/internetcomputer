...
grub_target_cppflags='-Wno-unused-but-set-variable -Wall -W  -DGRUB_MACHINE_XEN=1 -DGRUB_MACHINE=I386_XEN -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/13/include -I$(top_srcdir)/include -I$(top_builddir)/include'
